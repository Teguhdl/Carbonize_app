  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        _originalDateOfBirth = data['dateOfBirth']?.toString() ?? 'DD/MM/YYYY';
        _originalDailyCarbonLimit = data['dailyCarbonLimit']?.toString() ?? '6';
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        await _userService.updateUserData(currentUser.uid, {
          ...
          'daily_carbon_limit': int.tryParse(_dailyCarbonLimitController.text) ?? 6,
        });
