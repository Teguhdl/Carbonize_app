...
class _HomeScreenState extends State<HomeScreen> {
  ...
  double _totalMonthlyEmissions = 0;
  ...
  List<MonthlyEmission> _monthlyEmissions = [
    MonthlyEmission(month: 'January', value: 0),
    MonthlyEmission(month: 'February', value: 0),
    MonthlyEmission(month: 'March', value: 0),
    MonthlyEmission(month: 'April', value: 0),
    MonthlyEmission(month: 'May', value: 0),
    MonthlyEmission(month: 'June', value: 0),
    MonthlyEmission(month: 'July', value: 0),
    MonthlyEmission(month: 'August', value: 0),
    MonthlyEmission(month: 'September', value: 0),
    MonthlyEmission(month: 'October', value: 0),
    MonthlyEmission(month: 'November', value: 0),
    MonthlyEmission(month: 'December', value: 0),
  ];
  ...
  Future<void> _loadYearlyEmissions() async {
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        final String startDate = '${_selectedMonth.year}-01-01';
        ...
        double yearlyTotalFood = 0;
        double yearlyTotalFuel = 0;
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Icon(Icons.arrow_drop_down, color: Color(0xFFF0BB78), size: 28),
                      ],
                    ),
                  ),
                ),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${_totalMonthlyEmissions.toStringAsFixed(2)} kg',
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 22,
                                    fontWeight: FontWeight.bold,
  ...
  Widget _buildYearlyBarChart() {
    ...
    final List<String> yAxisLabels = [
      chartMaxValue.toStringAsFixed(1),
      (chartMaxValue * 0.75).toStringAsFixed(1),
      (chartMaxValue * 0.5).toStringAsFixed(1),
      (chartMaxValue * 0.25).toStringAsFixed(1),
      '0',
    ];
                      ...
                      return Stack(
                        children: [
                          ...
                          ...yAxisLabels.map((label) {
                            final labelValue = double.tryParse(label) ?? 0;
                            final y = constraints.maxHeight * (1 - (labelValue / chartMaxValue));
                            return Positioned(
                              top: y,
                              left: 0,
                              right: 0,
                          ...
                          ...List.generate(12, (index) {
                            ...
                            final chartHeight = constraints.maxHeight - 30; // space for labels
                            final barHeight = emission.value > 0
                                ? (emission.value / chartMaxValue) * chartHeight
                                : 0.0;
                            ...
                            if (emission.value > 0)
                              return Stack(
                                children: [
                                  ...
                                  Positioned(
                                    left: x - 4,
                                    bottom: 30 + barHeight + 2,
                                    child: SizedBox(
                                      width: barWidth + 8,
                                      child: Text(
                                        emission.value.toStringAsFixed(1),
                                        style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 8,
                                        ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            // Value
            Text(
              '${category.value.toStringAsFixed(2)} kg',
              style: const TextStyle(
                color: Color(0xFF5D6C24),
                fontSize: 13,
                fontWeight: FontWeight.w600,
            ...
            // Arrow icon
            const Icon(Icons.chevron_right, color: Color(0xFF5D6C24), size: 18),
          ],
        ),
      ),
    );
